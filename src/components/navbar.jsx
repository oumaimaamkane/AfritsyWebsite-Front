          ...
          <div className="relative flex h-16 items-center justify-between lg:border-b lg:border-sky-800">
            <div className="flex items-center px-2 lg:px-0">
              ...
              <div className="hidden lg:ml-6 lg:block lg:space-x-4">
                {/* <div className="flex">
                  <a href="/Dashboard" className="hover:bg-[#EFA300] bg-black bg-opacity-25 rounded-md py-2 px-6 m-3 text-sm font-medium text-white">Dashboard</a>
                  <a href="/DashboardServices" className="hover:bg-[#EFA300] bg-black bg-opacity-25 rounded-md py-2 px-3 m-3 text-sm font-medium text-white">Services</a>
                  <a href="#" className="hover:bg-[#EFA300] bg-black bg-opacity-25 rounded-md py-2 px-3 m-3 text-sm font-medium text-white">Members</a>
                  <a href="#" className="hover:bg-[#EFA300] bg-black bg-opacity-25 rounded-md py-2 px-3 m-3 text-sm font-medium text-white">Countries</a>
                  <a href="#" className="hover:bg-[#EFA300] bg-black bg-opacity-25 rounded-md py-2 px-3 m-3 text-sm font-medium text-white">Projects</a>
                </div> */}
              </div>
            </div>
            <div className="flex flex-1 justify-center px-2 lg:ml-6 lg:justify-end">
              <div className="w-full max-w-lg lg:max-w-xs">
                ...
                <div className="relative text-[#EFA300] focus-within:text-gray-400">
                  ...
                  <input id="search" name="search" className="block w-full rounded-md border border-transparent bg-[#EFA300] bg-opacity-50 py-2 pl-10 pr-3 leading-5 placeholder-orange-100 focus:border-white focus:bg-white focus:text-gray-900 focus:placeholder-gray-500 focus:outline-none focus:ring-white sm:text-sm" placeholder="Search" type="search" />
                </div>
              </div>
            </div>
            <div className="flex lg:hidden">
              <button type="button" className="inline-flex items-center justify-center rounded-md p-2 text-bg-[#EFA300] hover:bg-[#EFA300] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded={open} onClick={toggleMenu}>
                ...
                <div className="relative ml-4 flex-shrink-0">
                  ...
                  {open && (
                    <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button">
                      <a href="/project" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Your Projects</a>
          ...
          <div className="bg-sky-900 lg:hidden" id="mobile-menu">
            ...
            <div className="border-t border-sky-800 pt-4 pb-3">
              ...
              <div className="mt-3 px-2">
                <a href="/project" className="block rounded-md py-2 px-3 text-base font-medium text-orange-200 hover:bg-orange-600 hover:text-white">Your Projects</a>
