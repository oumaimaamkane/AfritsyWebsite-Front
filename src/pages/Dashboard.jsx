...
//   return (
//     <>
//       <div className={`body bg-white ${darkMode ? 'dark:bg-[#0F172A]' : ''}`}>
//         <div ref={sidebarRef} className={`fixed w-full z-30 flex ${darkMode ? 'bg-[#0F172A] ' : 'bg-white '} p-2 items-center justify-center h-16 px-10`}>
//           <div ref={logoRef} className={`logo ml-12 ${darkMode ? 'dark:text-white' : ''}  transform ease-in-out duration-500 flex-none h-full flex items-center justify-center`}>
//             NERVE
//           </div>
...
//           </div>
//         </div>
//         <aside className={`${sidebarOpen ? '' : '-translate-x-48'} fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B]`}>
//           {/* Sidebar content */}
...
//         </aside>
//         {/* <!-- CONTENT --> */}
//         <div ref={contentRef} className={`content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ${darkMode ? 'text-white' : 'text-black'}`}>
//           {/* Content goes here */}
...
function Dashboard() {
  ...
  return (
    <>
      <Sidebar />
      <main className={`p-5 transition-all duration-500 ${isSidebarOpen ? 'ml-60' : 'ml-20'}`}>
        <Navbar />
        <Breadcrumb />
      </main>
    </>
